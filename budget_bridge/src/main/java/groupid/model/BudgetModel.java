...
public class BudgetModel {
    ...
    public BudgetModel() {
        ...
        leaderboard.addAll(
            ...
            Map.entry("Alice", 10000),
            Map.entry("Bob", 9000),
            Map.entry("Charlie", 8000),
            Map.entry("Diana", 7000),
            Map.entry("Ethan", 6000), 
            Map.entry("Alice", 5000),
            Map.entry("Bob", 4000),
            Map.entry("Charlie", 3000),
            Map.entry("Diana", 2000),
            Map.entry("Ethan", 1000), 
            Map.entry("Alice", 900),
            Map.entry("Bob", 800),
